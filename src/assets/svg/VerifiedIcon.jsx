export const VerifiedIcon = () => (
  <svg
    ...
    role="img"
    className="r-4qtqp9 r-yyyyoo r-1xvli5t r-bnwqim r-lrvibr r-m6rgpd r-f9ja8p r-og9te1"
  ...
  >
    <g>
      <linearGradient
        ...
        y2="21.508"
      >
        <stop offset="0" stopColor="#A0E1FF"></stop>
        <stop offset=".539" stopColor="#1B96D1"></stop>
        <stop offset=".68" stopColor="#1281B3"></stop>
        <stop offset="1" stopColor="#A0E1FF"></stop>
      </linearGradient>
      <linearGradient
        gradientUnits="userSpaceOnUse"
        id="18-b"
        ...
        y2="19.133"
      >
        <stop offset="0" stopColor="#D1F0FF"></stop>
        <stop offset=".406" stopColor="#60C6FF"></stop>
        <stop offset=".989" stopColor="#60C6FF"></stop>
      </linearGradient>
